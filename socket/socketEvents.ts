...
export const testSocket = (payload: any, off: boolean = false) => {
    ...
    if(off) {
        ...
        socket.off("testSocket", payload);      // payload is the calback
...
export const updateProfile = (payload: any, off: boolean = false) => {
    ...
    if(off) {
        // turn off listening to this event; 
        socket.off("updateProfile", payload);      // payload is the calback
    } else if(typeof payload == "function") {
...
export const getContacts = (payload: any, off: boolean = false) => {
    ...
    if(off) {
        // turn off listening to this event; 
        socket.off("getContacts", payload);      // payload is the calback
    } else if(typeof payload == "function") {
...
export const newConversation = (payload: any, off: boolean = false) => {
    ...
    if(off) {
        // turn off listening to this event; 
        socket.off("newConversation", payload);      // payload is the calback
    } else if(typeof payload == "function") {
...
export const getConversations = (payload: any, off: boolean = false) => {
    ...
    if(off) {
        // turn off listening to this event; 
        socket.off("getConversations", payload);      // payload is the calback
    } else if(typeof payload == "function") {
...
export const newMessage = (payload: any, off: boolean = false) => {
    ...
    if(off) {
        // turn off listening to this event; 
        socket.off("newMessage", payload);      // payload is the calback
    } else if(typeof payload == "function") {
...
export const getMessages = (payload: any, off: boolean = false) => {
    ...
    if(off) {
        // turn off listening to this event; 
        socket.off("getMessages", payload);      // payload is the calback
    } else if(typeof payload == "function") {
